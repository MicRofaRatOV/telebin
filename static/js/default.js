...
(async ({chrome, netscape}) => {
    ...
    if (!chrome && !netscape)
      await import("/static/plugin/textarea-md/custom-elements.min.js");

    const {default: HighlightedCode} =
      await import("/static/plugin/textarea-md/highlighted-code-FIX.min.js");
...
// document.getElementById("home-pill").click(); // TODO: remove
...
// On click to pills
document.querySelector("#home-pill").onclick = function() { history.pushState({}, null, "/"); };
document.querySelector("#new-bin-pill").onclick = function() { history.pushState({}, null, "/new-bin/"); };
document.querySelector("#my-bins-pill").onclick = function() { history.pushState({}, null, "/my-bins/"); };
document.querySelector("#account-pill").onclick = function() { history.pushState({}, null, "/account/"); };
